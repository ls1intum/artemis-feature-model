 ...
 * enforced by the scan: they stay in status {@code candidate} until manifest curation decides about them.
 *
 ...
 * @param status lifecycle status; always {@code candidate} in the persisted scan artifact.
