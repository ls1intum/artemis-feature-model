...
public record GuidedDecisionOption(String id, String label, String description, List<String> selects, List<String> deselects,
        List<String> requiresCapabilities, List<String> consequences, List<String> artifactImpacts, List<String> warnings) {
     ...
     * @param artifactImpacts user-facing artifact generation impact text.
